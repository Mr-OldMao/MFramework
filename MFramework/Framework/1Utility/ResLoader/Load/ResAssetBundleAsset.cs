...
namespace MFramework
{
    ...
    public class ResAssetBundleAsset : AbRes
    {
        ...
        {
            base.resType = ResType.ResAssetBundleAsset;
        ...
        public override void LoadAsync(Action<AbRes> callback)
        {
            ...
            ResLoader.LoadAsync<AssetBundle>(ResType.ResAssetBundlePack, (ab) =>
            {
        ...
        public override bool LoadSync()
        {
            ResState = ResStateType.Loading;
            AssetBundle ab = null;
            if (ResLoader.CheckResExist(base.AssetAllPath, ResType.ResAssetBundlePack) == null)
            {
                ab = ResLoader.LoadSync<AssetBundle>(ResType.ResAssetBundlePack, base.AssetAllPath);
            }
            else
            {
                ab = ResLoader.CheckResExist(base.AssetAllPath, ResType.ResAssetBundlePack).Asset as AssetBundle;
            }
            //ab = ResLoader.LoadSync<AssetBundle>(ResType.ResAssetBundlePack, base.AssetAllPath);
            base.Asset = ab.LoadAsset(m_AssetName); //需要加后缀
